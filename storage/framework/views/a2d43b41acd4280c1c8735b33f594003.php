...
<head>
    ...
    <style>
        ...
        #email-reg-info, #auth-info, #reg-info{
            display: none;
            color: red;
        }
...
<div class="container">
    ...
    <div class="center-all" id="form-auth">
        ...
        <div class="col-6"
             style="border: 1px solid #4ad9f6; border-radius: 5px; padding: 10px;  background: aliceblue;">
            <div class="col p-sm">
    ...
    <div class="center-all" id="form-reg">
        ...
        <div class="col-6 align-self-center"
             style="border: 1px solid rgba(116,246,89,0.16); border-radius: 5px; padding: 10px; background: #dff0d8">
            <div class="col p-sm">
...
<?php /**PATH C:\OSPanel\domains\l\lar-app\resources\views/login.blade.php ENDPATH**/ ?>