...
<div class="container">
    ...
    <div class="center-all p-sm">
        <h3>Здравствуйте, <?php echo e($_SESSION['notes_user']['name']); ?>!</h3>
    </div>
    <?php
    ...
    <table class="table table-bordered table-sm">
        ...
        ?>
        <tr id="row_<?php echo e($note->id); ?>">
            <td>
                <div id="title_<?php echo e($note->id); ?>">
                    <?php echo htmlspecialchars($note->title); ?>

                </div>
                <input id="edittitle_<?php echo e($note->id); ?>" class="form-control" value="<?php echo e($note->title); ?>"
                       style="display: none;">
            </td>
            <td>
                <div id="content_<?php echo e($note->id); ?>">
                    <?php echo htmlspecialchars($note->content); ?>

                </div>
                <textarea id="editcontent_<?php echo e($note->id); ?>" class="form-control" style="display: none; width: 100%;">
                        <?php echo e($note->content); ?>

                    </textarea>
            </td>
            <td>
                <button id="edit0-btn-<?php echo e($note->id); ?>" class="btn btn-outline-success btn-sm"
                        onclick="noteToEdit(<?php echo e($note->id); ?>)">Редактировать
                </button>
                <button id="edit-btn-<?php echo e($note->id); ?>" class="btn btn-warning btn-sm" style="display: none;"
                        onclick="edit(<?php echo e($note->id); ?>);">
                    Отправить
                </button>
                <button class="btn btn-outline-danger btn-sm" onclick="deleteNote(<?php echo e($note->id); ?>);">Удалить</button>
                <div id="edit-info-<?php echo e($note->id); ?>" onclick="hide('edit-info-<?php echo e($note->id); ?>');"></div>
            </td>
        </tr>
        <?php
        }
...
<?php /**PATH C:\OSPanel\domains\l\lar-app\resources\views/notes.blade.php ENDPATH**/ ?>